...
public class Customer_Update {
    ...
    public class UpdateCustomer_Inner extends JFrame {
        ...
        public UpdateCustomer_Inner() {
            ...
            ADR_Label = new JLabel("Enter ADR (without dashes)");
            ...
            ADR_TextField = new JTextField(customer.getADR());
            ...
            add(ADR_Label, new AbsoluteConstraints(10, 5));
            add(ADR_TextField, new AbsoluteConstraints(195, 5));
            add(ADRValidity_Label, new AbsoluteConstraints(195, 30));
            ...
            Update_Button.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (!cnic.isEmpty()) {
                        ...
                        if (Customer.isADRValid(cnic)) {
                            System.out.println("ADR is valid");
                            Customer CO = Customer.SearchByADR(cnic);
                            if (CO != null) {
                                if (cnic.equals(customer.getADR())) {
                                    System.out.println("no change in cnic");
                                } else {
                                    cnic = null;
                                    JOptionPane.showMessageDialog(null, "This ADR is already registered !");
                                }
                            } else { // when Customer.SearchADR(M) returned null
                                System.out.println("new ADR is entered");
                            }
                        } else {
                            cnic = null;
                            ADRValidity_Label.setText("Invalid ADR !");
                        }
                    } else {
                        cnic = null;
                        ADRValidity_Label.setText("Enter ADR !");
                    }
                    if (!name.isEmpty()) {
