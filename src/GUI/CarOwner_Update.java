...
public class CarOwner_Update {
    ...
    public class UpdateCarOwner_Inner extends JFrame {
        ...
        public UpdateCarOwner_Inner() {
            ...
            ADR_TextField = new JTextField(carOwner.getADR());
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (!cnic.isEmpty()) {
                        ...
                        if (CarOwner.isADRValid(cnic)) {
                            ...
                            CarOwner CO = CarOwner.SearchByADR(cnic);
                            if (CO != null) {
                                if (cnic.equals(carOwner.getADR())) {
                                    System.out.println("no change in cnic");
                                } else {
                                    cnic = null;
                                    JOptionPane.showMessageDialog(null, "This ADR is already registered !");
                                }
                            } else { // when CarOwner.SearchADR(M) returned null
